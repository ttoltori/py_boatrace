...
# model生成するクラス
#
class BoatCatboostRankerTrainer:
    def __init__(self):
    ...
    def execute(self, param_list_str, csv_filepath, model_filepath, feature_name_list_str, feature_type_list_str):
        ...
        train_pool = Pool(data=X, label=y, group_id=X['raceid'], cat_features=cat_features)
        ...
        param = {'loss_function':'YetiRank', 'learning_rate': 0.03, 'iterations': 100, 'depth': 7, 'use_best_model':False}   
...
def main(argv):
    ...
    tester = BoatCatboostRankerTrainer()
